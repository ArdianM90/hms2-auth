 ...
 */
package com.hms.auth.generated.jooq.tables;

import com.hms.auth.generated.jooq.Auth;
import com.hms.auth.generated.jooq.Keys;
...
public class AppUser extends TableImpl<AppUserRecord> {
  ...
  public final TableField<AppUserRecord, UUID> USER_ID =
      createField(
          DSL.name("user_id"),
          SQLDataType.UUID
              .nullable(false)
  ...
  public final TableField<AppUserRecord, String> USERNAME =
  ...
  public final TableField<AppUserRecord, String> EMAIL =
      createField(DSL.name("email"), SQLDataType.CLOB.nullable(false), this, "");

  /** The column <code>auth.app_user.password_hash</code>. */
  public final TableField<AppUserRecord, String> PASSWORD_HASH =
      createField(DSL.name("password_hash"), SQLDataType.CLOB.nullable(false), this, "");

  /** The column <code>auth.app_user.is_active</code>. */
  public final TableField<AppUserRecord, Boolean> IS_ACTIVE =
      createField(
          DSL.name("is_active"),
          SQLDataType.BOOLEAN
              .nullable(false)
  ...
  public final TableField<AppUserRecord, LocalDateTime> CREATED_AT =
      createField(
          DSL.name("created_at"),
  ...
  private AppUser(
      Name alias, Table<AppUserRecord> aliased, Field<?>[] parameters, Condition where) {
  ...
  public AppUser where(Condition condition) {
    return new AppUser(
        getQualifiedName(), aliased() ? this : null, null, Internal.condition(this, condition));
  }
